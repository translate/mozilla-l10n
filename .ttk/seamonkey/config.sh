...
OTHER_EXCLUDED_DIRS="browser dom netwerk security services/sync toolkit webapprt mobile embedding calendar chat editor/ui mail other-licenses/branding/thunderbird"
