...
PRODUCT_DIRS="browser devtools dom netwerk security services/sync toolkit webapprt" # Directories in language repositories to clear before running po2moz
...
MOZ_REPO=mozilla-beta
MOZ_DIR="mozilla-beta"
L10N_VER=l10n-beta
