...
OTHER_EXCLUDED_DIRS="browser devtools dom netwerk security services/sync toolkit webapprt mobile embedding chat editor/ui mail other-licenses/branding/thunderbird suite"
